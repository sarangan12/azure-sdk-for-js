# Azure FluidRelayManagement client library for JavaScript
...
[API reference documentation](https://docs.microsoft.com/javascript/api/@azure/arm-fluidrelay?view=azure-node-preview) |
